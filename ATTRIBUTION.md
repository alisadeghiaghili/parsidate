...
As required by the GPL-3.0 license and to ensure proper credit, if you use,
...
1. INCLUDE AUTHOR NAME
   - Display: "Ali Sadeghi Aghili"
...
3. INCLUDE LICENSE INFORMATION
   - State: "Licensed under GPL-3.0-or-later"
   - Provide link to full license text
   - Recommend: https://www.gnu.org/licenses/gpl-3.0.html

4. DOCUMENT ALL MODIFICATIONS
   - If you modified the code, clearly state what was changed
   - Keep record of modifications
   - Share modifications per GPL-3.0 requirement

5. PROVIDE SOURCE CODE
   - If distributing ParsiDate, provide source code
...
```python
"""
This module uses ParsiDate for date operations.
...
from parsidate import jmd, ymd, to_gregorian
```
...
1. jalali Package
   ...
   - License: GPL-3.0
   - Used for: Persian calendar algorithms

2. lubridate Package
   - Authors: Hadley Wickham, Garrett Grolemund, Vitalie Spinu
   - Repository: https://lubridate.tidyverse.org
   - License: GPL-3.0
   - Used for: Date manipulation API design and concepts
...
"When you convey a copy of a covered work...you must pass on the recipients
...
Q: Can I make ParsiDate closed-source?
A: No. GPL-3.0 requires source code to remain open.

Q: Can I remove the attribution?
A: No. You cannot remove copyright notices or attribution.

Q: What if I use ParsiDate in a private/internal project?
A: Still covered by GPL-3.0. Attribution still required.

Q: Can I use ParsiDate in commercial software?
A: Yes, but your software must also be GPL-3.0 and open source.

Q: How detailed must attribution be?
A: At minimum: Author name, project name, and license type.
   Ideally: Include repository link for easy reference.

Q: Do I need permission to use ParsiDate?
